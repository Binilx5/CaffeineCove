...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative overflow-hidden">
      ...
      <div className="hidden lg:flex min-h-screen" style={{backgroundColor: '#F5F0EA'}}>
        ...
        <div className="relative w-full min-h-screen">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-60 right-12 opacity-10">
              <i className="bi bi-circle-fill text-coffee text-lg"></i>
            </div>
            ...
            <div className="absolute top-16 right-1/4 ml-2 opacity-15">
          ...
          {/* Main Content Layout */}
          <div className="relative z-10 flex items-center justify-between min-h-screen p-12">
      ...
      <div className="lg:hidden">
        ...
        <div className="relative min-h-screen" style={{backgroundColor: '#F5F0EA'}}>
          ...
          <div className="relative z-10 flex flex-col min-h-screen p-6 pt-36 sm:pt-40 md:pt-44">
